...
var appAccordion1 = new _accordion.Accordion('.accordion1');

var appAccordion2 = new _accordion.Accordion('.accordion2');
var appAccordion3 = new _accordion.Accordion('.accordion3');
var appAccordion4 = new _accordion.Accordion('.accordion4');
...
var Accordion = function () {
    function Accordion(cssSelector) {
        var _this = this;

        _classCallCheck(this, Accordion);

        this.rootElement = document.querySelector(cssSelector);
        this.caretArrow = this.rootElement.querySelector('.fa-caret-right');
        this.controlBtn = this.rootElement.querySelector('.accordion-control');
        this.panel = this.rootElement.querySelector('.accordion-panel');
        this.isShown = false;
    ...
    _createClass(Accordion, [{
        ...
        value: function show() {
            ...
            this.caretArrow.classList.add(ROTATE_CLASS);
            this.controlBtn.classList.add(ACTIVE_CLASS);
        }
    }, {
        key: 'hide',
        value: function hide() {
            ...
            this.caretArrow.classList.remove(ROTATE_CLASS);
            this.controlBtn.classList.remove(ACTIVE_CLASS);
        }
    }]);
